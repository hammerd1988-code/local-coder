...
- Repository CI currently installs dependencies and runs static/build checks on Node 20. That unsupported runtime does not replace the Node >=22 SQLite smoke/startup check for end-to-end validation.
